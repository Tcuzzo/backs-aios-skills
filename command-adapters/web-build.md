...
Load the bundled `plays/web-app-builds.md` using `${CLAUDE_PLUGIN_ROOT}/plays/web-app-builds.md` in Claude Code or `${CURSOR_PLUGIN_ROOT}/plays/web-app-builds.md` in Cursor, then execute it, whole, on: $ARGUMENTS
